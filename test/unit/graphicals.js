...
(function () {
  ...
  test("Testing Circle", function () {
    ...
    equal(
      Math.round(currBB.width),
      Math.round(origBB.width),
      "scale undone correctly"
    );
    ...
    currBB = c.rObj.getBBox();
    equal(
      Math.floor(currBB.width),
      Math.round((origBB.width + 40) * 2),
      "scale redone correctly"
    );
  ...
  test("Testing Ellipse", function () {
    ...
    equal(
      Math.round(currBB.width),
      Math.round(origBB.width),
      "horizontal scale undone correctly"
    );
    equal(
      Math.round(currBB.height),
      Math.round(origBB.height),
      "vertical scale undone correctly"
    );
    ...
    equal(
      Math.floor(currBB.width),
      Math.round((origBB.width - 40) * 2),
      "hor scale redone correctly"
    );
    equal(
      Math.floor(currBB.height),
      Math.round((origBB.height - 40) * 2),
      "vert scale redone correctly"
    );
  ...
  test("Testing Rectangle", function () {
    ...
    equal(
      Math.floor(currBB.width),
      Math.round((origBB.width + 30) * 2),
      "hor scale redone correctly"
    );
    equal(
      Math.floor(currBB.height),
      Math.round((origBB.height - 10) * 2),
      "vert scale redone correctly"
    );
  ...
  test("Test Label show/hide", function () {
    ...
    equal(
      label.element.filter(":visible").size(),
      1,
    ...
    equal(
      label.element.filter(":visible").size(),
      1,
      "Label again visible after show"
    );
    label.show();
    av.step();
    equal(
      label.element.filter(":visible").size(),
      1,
      "Label visible after another show"
    );
    label.hide();
    av.step();
    equal(
    ...
    equal(
      label.element.filter(":visible").size(),
      0,
      "Label not visible after another hide"
    );
    av.recorded();
    jQuery.fx.off = true;
    av.end();
  ...
  test("Test Label state() function", function () {
    ...
    ok(
      !label1.equals(label2, {
        css: ["font-size", "border"],
        class: ["testing", "testing2"],
      })
    );
