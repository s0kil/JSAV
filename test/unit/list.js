...
(function () {
  ...
  var testListValues = function (list, values) {
    ...
    while (node) {
      ...
      deepEqual(
        values[i],
        node.value(),
        "Testing index " + i + " of values " + values
      );
      i++;
      node = node.next();
    }
  ...
  test("Test list equals function", function () {
    ...
    ok(
      !list1.equals(list2),
      "Empty list should not be equal with non-empty list"
    );
    ok(
      !list2.equals(list1),
      "Non-empty list should not be equal with empty list"
    );
    list1.addFirst(1);
    list1.addFirst(2);
    list1.addFirst(3);
    ...
    ok(
      list1.equals(list2),
      "Lists with equal values should be equal when not comparing css or classes"
    );
    ok(
      !list1.equals(list2, { css: "background-color" }),
      "Lists with same values but different css should not be equal"
    );
    ok(
      !list1.equals(list2, { class: "jsavhighlight" }),
      "Lists with same values but different class should not be equal"
    );

    list2.first().highlight();
    ok(
      list1.equals(list2, { css: "background-color" }),
      "Lists with same values and css should be equal"
    );
    ok(
      list1.equals(list2, { class: "jsavhighlight" }),
      "Lists with same values and class should be equal"
    );
    ...
    ok(
      !list1.equals(list2, { css: "stroke" }),
      "Lists with same values but different edge css should not be equal"
    );
    ...
    ok(
      list1.equals(list2, { css: "stroke" }),
      "Lists with same values and edge css should be equal"
    );

    list1.removeLast();
    ok(
      !list1.equals(list2),
      "Lists with different number of nodes should not be equal"
    );
    list2.removeLast();
  ...
  test("Test list state function", function () {
    ...
    ok(
      list1.equals(list2, { class: ["jsavhighlight", "testing"] }),
      "List values and classes should equal after setting state"
    );
    ok(
      list1.equals(list2, {
        css: ["color", "stroke"],
