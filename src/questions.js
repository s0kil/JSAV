...
(function ($) {
  ...
  var questionSetting = function (jsav) {
    return function () {
      ...
      var $elem = $(
        '<div class="jsavrow">Show Questions: ' +
          '<input id="' +
          idPrefix +
          'Yes" type="radio" value="true" name="jsav-questions" />' +
          '<label for="' +
          idPrefix +
          'Yes">Yes</label>' +
          '<input  id="' +
          idPrefix +
          'No" type="radio" value="false" name="jsav-questions" />' +
          '<label for="' +
          idPrefix +
          'No">No</label>' +
          "</div>"
  ...
  var createInputComponent = function (label, itemtype, options) {
    var labelElem = $('<label for="' + options.id + '">' + label + "</label>"),
      input = $('<input id="' + options.id + '" type="' + itemtype + '"/>');
  ...
  qTypes.MC = {
    ...
    addChoice: function (label, options) {
      this.choices.push(
        new QuestionItem(label, "radio", $.extend({ name: this.name }, options))
      );
      return this;
    },
    feedback: feedbackFunction,
