...
(function ($) {
  ...
  JSAV._translations = {
    ...
    fr: {
      ...
      fixedPopup:
        "Votre dernière action etait incorrecte. Votre action a été corrigée pour vous permettre de poursuivre.",
      fixFailedPopup:
        "Votre dernière action etait incorrecte et je ne sais pas comment la corriger. Votre action a ete annulée, essayez a nouveau.",
      undonePopup:
        "Votre dernière action etait incorrecte. La simulation a été reinitialisée. Essayez a nouveau.",
