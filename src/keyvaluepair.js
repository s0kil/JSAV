...
(function ($) {
  ...
  keyValuePairPrototype.css = function (cssprop, options) {
    ...
    } else if (!$.isArray(cssprop) && typeof cssprop === "object") {
  ...
  keyValuePairPrototype.toggleClass = JSAV.anim(function (
    pairSection,
    className,
    options
  ) {
